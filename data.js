                ...
                var node=$(`<div class = 'home-banner-box'>
                    ...
                    <div class = 'home-brick-box home-brick-row-2-box xm-plain-box'>
                        ...
                        for(var k=0;k<hotChilds.length;k++){
                            $(`<div>
                                    <li class = 'brick-item ${k==7?"brick-item-s":"brick-item-m brick-item-2"}'>
                                        <a href="#">
                                            <div class = 'figure figure-img'>
                                            ...
                                            <p class = 'price'>
                                                ...
                                                <del>
                                                    <span class = 'num'>${hotChilds[k].del==0?"":"hotChilds[k].del"}</span>元
                                                </del>
                                            </p>
                                        </a>
                                    </li>
                        ...
                        $(`<li class = 'brick-item brick-item-s'>
                            ...
                            for(var l=0;l<Childs.length;l++){
                                $(`<div>
                                    <li class = 'brick-item ${l==7?"brick-item-s":"brick-item-m brick-item-2"}'>
                                        <a href="#">
                                            <div class = 'figure figure-img'>
                                            ...
                                            <p class = 'price'>
                                                ...
                                                <del>
                                                    <span class = 'num'>${Childs[l].del==0?"":"Childs[l].del"}</span>元
                                                </del>
                                            </p>
                                        </a>
                                    </li>
